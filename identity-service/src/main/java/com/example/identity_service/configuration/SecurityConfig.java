...
public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
    httpSecurity
            ...
            .authorizeHttpRequests(request -> request
                    .requestMatchers(HttpMethod.GET, "/users/**").permitAll()  // Permit GET requests to /verify-email
                    .requestMatchers(HttpMethod.POST, PUBLIC_ENDPOINTS).permitAll()    // Permit POST requests to PUBLIC_ENDPOINTS
